...
class RestaurantMenusControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create restaurant_menu" do
    assert_difference('RestaurantMenu.count') do
      post restaurant_menus_url, params: { restaurant_menu: { amount: @restaurant_menu.amount, image: @restaurant_menu.image, type_of_food: @restaurant_menu.type_of_food } }
    end
  ...
  test "should update restaurant_menu" do
    patch restaurant_menu_url(@restaurant_menu), params: { restaurant_menu: { amount: @restaurant_menu.amount, image: @restaurant_menu.image, type_of_food: @restaurant_menu.type_of_food } }
