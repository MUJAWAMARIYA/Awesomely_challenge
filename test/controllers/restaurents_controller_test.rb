...
class RestaurentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create restaurent" do
    assert_difference('Restaurent.count') do
      post restaurents_url, params: { restaurent: { details: @restaurent.details, location: @restaurent.location, name: @restaurent.name } }
    end
  ...
  test "should update restaurent" do
    patch restaurent_url(@restaurent), params: { restaurent: { details: @restaurent.details, location: @restaurent.location, name: @restaurent.name } }
